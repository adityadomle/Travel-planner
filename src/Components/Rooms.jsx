...
const Rooms = () => {
  return (
    <div className='max-w-[1400px] h-[500px] bg-red-100 mx-auto my-20 pt-16 lg:mb-[20%] md:mb-[35%] px-4 grid lg:grid-cols-3 gap-4'>
      <div className='lg:top-20 relative lg:col-span-1 col-span-2'>
        <h3 className='text-2xl font-bold'>Fine Interior Rooms</h3>
        <p className='pt-4'>
          Discover elegant interiors designed for luxury and comfort. Our rooms
          offer stunning views, cozy ambiance, and the perfect retreat after a
          long day of travel.
        </p>
      </div>
